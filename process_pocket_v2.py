...
def get_all_pocket_data(pocket_number, pocket_file, coordinate, res, pdb_code):
    ...
    table['searched_coordinate'] = str(coordinate)
    table['searched_residue'] = res
    table['pdb_code'] = pdb_code
    return table

def usage():
    print('Usage: python3 process_pockets.py <FPOCKET_OUT_DIR> ' +
    'RESIDUE_MAPPING> <DISTANCE IN ANG> <OUTPUT_DIRECTORY_NAME> <SEARCH_PDB_FOLDER>')
